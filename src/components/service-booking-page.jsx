...
export const ServiceBookingPage = () => {
    ...
    const { service, car, bookingDetails, total_price } = state || {};  // Destructure bookingDetails and car

    console.log('Service Booking Page State total price: ', total_price);
    ...
    return (
        <>
            ...
            <div className="w-full bg-gray-100 p-20">
                <h2 className="text-2xl font-semibold text-black mb-4">Booking Car Service - {service.service}</h2>
